...
Исходный код компьютерных экспериментов отображён в ПРИЛОЖЕНИИ А.
\vspace*{1cm}
\begin{figure}[h]
...
\begin{figure}[h]
	...
	\caption{График зависимости разности асимптотического и точного значений энтропии биграммы от доли вкрапления}
	\label{ris:"h2.png"}
\end{figure}
...
\begin{figure}[h]
	...
	\caption{График зависимости разности асимптотического и точного значений энтропии 3-граммы от доли вкрапления}
	\label{ris:"h3.png"}
\end{figure}
\begin{figure}[h]
