...
Учитывая (\ref{macklaren}), найдём асимптотические выражения при $\delta \rightarrow 0$ для собственной информации $I\{y_{t-1}=i_1, y_t = i_2 \}, i_1,i_2 \in \{0,1\}$:
\begin{gather*}
...
Линейный дискриминантный анализ применён для классификации последовательностей с вкраплениями и без вкраплений при фиксированном параметре $\varepsilon$.\newline
...
\end{equation}
$\nu_0$ - количество верно определённых пустых последовательностей,
$\nu_1$ - количество верно определённых последовательностей с вкраплениями.\newline
Мощность критерия:
\begin{equation}
\hat{w} = \frac{\nu_1}{n_1} 
\end{equation}
...
волн, причём оси X и Y совпадают с шириной и высотой картинки, а по оси Z
...
часть информации можно безболезненно выбросить, не внося серьёзных искажений в
картинку.
